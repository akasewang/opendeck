...
export type IconProps = Omit<IconifyIconProps, 'icon'> & { size?: number }
...
export const ArrowUp = icon('ri:arrow-up-line')
...
export const CreativeCommons = icon('ri:creative-commons-line')
